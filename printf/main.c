...
/*   Updated: 2021/03/20 10:19:18 by hkubo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    int a11;
    int a12;
    i = printf("printf:    [%32p%p%p%p%p%p%p%p%p%p%p%p]\n", &a1,&a2,&a3,&a4,&a5,&a6,&a7,&a8,&a9,&a10,&a11,&a12);
    j = ft_printf("ft_printf: [%32p%p%p%p%p%p%p%p%p%p%p%p]\n", &a1,&a2,&a3,&a4,&a5,&a6,&a7,&a8,&a9,&a10,&a11,&a12);
    printf("len: %d\n", i);
    printf("len: %d\n", j);
    i = printf("printf:    [%p]\n", NULL);
