...
/*   Updated: 2021/08/15 17:12:10 by hkubo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate(t_info *info)
{
	...
	while (i < info->row_count - 1)
	{
		...
		{
			x_convert = convert_x(info->map[i][j].x * 50, info->map[i][j].y * 50, 30.0);
			// y_convert = convert_y(info->map[i][j].x * 10, info->map[i][j].y * 10, info->map[i][j].z / 10, 30.0);
			y_convert = convert_y(info->map[i][j].x * 50, info->map[i][j].y * 50, 0, 30.0);
