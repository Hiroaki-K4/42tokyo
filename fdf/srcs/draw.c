...
/*   Updated: 2021/08/16 22:38:00 by hkubo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_map(t_info *info)
{
	...
	while (i < info->row_count - 1)
	{
		...
		while (j < info->col_count[i])
		{
			...
			y_convert = convert_y(info->map[i][j].x * info->ratio * 0.7, info->map[i][j].y * info->ratio * 0.7, info->map[i][j].z * info->ratio * 0.01, 30.0);
