...
/*   Updated: 2021/07/31 17:38:19 by hkubo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	int *sorted_list)
{
	...
	top_flag = 0;
	sort_tool = init_sort_tool(stack_min(*stack_a), output_flag, sorted_list, &pivot_list);
	// pivot_list = init_pivot_list(sort_tool.all_min);
